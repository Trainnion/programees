...
def main():
    ...
    while True:
        ...
        print("🧠 Vic Luzano’s Algorithm Nexus: Engaging Neural Engines… 🧠\n")
        print(random.choice([
            "What knowledge node would you like to activate today?",
            "Choose a digital dilemma to decipher:",
            "Navigate through the matrix of algorithms below:",
            "Which computational quest shall we embark on?",
        ]))
        ...
        try:
            ...
            print(random.choice([
                "\n🚫 That input isn’t numeric. Try once more.",
                "\n❌ Please enter a valid number.",
                "\n⚠️ Digits only, brave coder. Go again!",
            ]))
            sleep(1.5)
            continue
        ...
        if choice == 0:
            print(random.choice([
                "\n👋 Journey complete. Return soon for more logic!",
                "\n🔚 Session ended. Keep those circuits sharp!",
                "\n🌠 Until next time, algorithm explorer!",
            ]))
            break
        ...
        if 1 <= choice <= len(modules):
            ...
            while True:
                ...
                again = input(random.choice([
                    "\n🔁 Want to dive into this module again? (y/N): ",
                    "\n♻️ Reboot this challenge? (y/N): ",
                    "\n🔄 Run it once more? (y/N): ",
                ])).strip().lower()
            ...
            print(random.choice([
                "\n⚠️ Invalid selection. That option doesn’t exist.",
                "\n🚫 Not on the list — pick again.",
